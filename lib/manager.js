...
class Manager extends Employee {
    constructor(name, id, email, number) {
        ...
        // it will set name, id, and email as properties for Manager
        super(name, id, email);
        this.role = "Manager";
        this.number = number;
        this.cardManager =
                ...
                <div class="card-body">
                    ...
                    <div class="card border-0" style="background-color: #201C2B; margin-top: .5em;">
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item" style="background-color: #E88BC3; color: #201C2B; border-bottom-left-radius: 8px; border-bottom-right-radius: 8px;">Employee Phone:&nbsp ${this.number}</li>
                        </ul>
                    </div>
                </div>
            </div>
